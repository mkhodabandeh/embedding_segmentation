...
start = 1 
machine = 'cs-vml-16'
videos = ['kangaroo_fihting', 'planet_earth_2', 'swimming']
parameters = {
...
def dfs(i, params_list, cmd, processes):
    if i == len(params_list):
        ...
        processes.append('python {0}/ExperimentSetup.py {1} -c {2} -f -s  > {3}/exp_{2}_{4}.log 2>&1'.format(proj_path,params_str, comment_str, log_path, machine))
