...
os.system('cd $graph; matlab -nodisplay -nosplash -nodesktop -r "run_test(\'{}\',\'{}\',\'{}\');exit;"'.format(conf.experiment_folder_name, conf.db_settings['level'], conf.db_settings['action_name'][0]))
